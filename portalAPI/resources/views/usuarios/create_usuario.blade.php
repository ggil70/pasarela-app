  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div >    
              <!-- Bordered Table -->
              <div class="card">
                <span style="margin-top:0.6em; margin-left: 0.6em; font-size:20px">Agregar usuario aliado</span>
                <hr>

                    <main class="card-body">
                        <form action="<?=route('save_incluirUsuario')?>" method="POST" autocomplete="off">
                        @csrf
