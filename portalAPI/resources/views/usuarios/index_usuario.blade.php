  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div >    
              <!-- Bordered Table -->
              <div class="card">
                <span style="margin-top:0.6em; margin-left: 0.6em; font-size:20px">Usuarios</span>
                <hr>
                <div style="text-align: right; margin-right: 1.8em;">
                <a href="<?=route('usuario_add')?>" class="btn btn-primary">
                          Incluir
                </a>
                </div>
                    ...
                    <table class="table table-bordered" id="myTable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div>
                              <a href="<?=route('usuario_update',$registro->id)?>"><img src="{{ asset('img/modificar.png') }}" width="20" height="15" alt="Modificar" ></a>

                              &nbsp;&nbsp;

                              <a href="<?=route('usuario_delete',$registro->id)?>">
