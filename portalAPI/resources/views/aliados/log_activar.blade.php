        ...
        <div >    
              ...
              <div class="card">
                <div class="form-group row">
                    <div class="col-md-10">
                         <span style="margin-top:10px; margin-left: 0.6em; font-size:20px">Log Activar / Desactivar Aliados</span>
                    </div>    
                    <div class="col-md-1" style="text-align: right; margin-right: 1.8em; margin-top:0.6em;">
                        <a href="<?=route('act_cliente')?>" class="btn btn-primary">
                          Regresar
                        </a>
                    </div>                       
                </div>    
                    ...
                    <table class="table table-bordered" id="myTable">
                      <thead>
                        <tr>
                          ...
                          <th width = "30%" style="text-align: left;">Funcional</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><span class="badge bg-label-primary me-1">{{ $registro->motivo }}</span></td>
                          <td style="text-align: left;">{{ $registro->id_usuario }}</td> 
