  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div >    
              <!-- Bordered Table -->
              <div class="card">
                <span style="margin-top:0.6em; margin-left: 0.6em; font-size:20px">Apis</span>
                <hr>
                <div style="text-align: right; margin-right: 1.8em;">
                <a href="<?=route('api_add')?>" class="btn btn-primary">
                          Incluir
                </a>
                </div>
                ...
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered" id="myTable">
                      <thead>
                        <tr>
                          <th width = "25%">Nombre de Api</th>
                          <th width = "35%">Descrpción</th>
                          <th width = "20%">Tipo Api</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $registro->nob_api }}</td>
                          <td>{{ $registro->desc_api }}</td>
                          <td>{{ $registro->nob_tipo_api }}</td>
                          ...
                          <td>
                            <div>
                              <a href="<?=route('api_update',$registro->id)?>"><img src="{{ asset('img/modificar.png') }}" width="20" height="15" alt="Modificar" ></a>

                              &nbsp;&nbsp;
                              <a href="<?=route('api_delete',$registro->id)?>">
...
<script>
    ...
    function sweetAlert(tipo, titulo, config, footer, time) {
       ...
       @if(session()->get('swEliminarRol')== 1)
           sweetAlert("success", "El registro fue eliminado satisfactoriamente'", true, "", 3000);
           @php
