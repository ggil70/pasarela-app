  ...
  <div class="layout-wrapper layout-content-navbar">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div >    
              <!-- Bordered Table -->
              <div class="card">
                <span style="margin-top:0.6em; margin-left: 0.6em; font-size:20px">Agregar Api</span>
                <hr>

                    <main class="card-body">
                        <form action="<?=route('save_incluirApi')?>" method="POST">
                        @csrf
                            <div class="form-group row">
                                <label for="name" class="col-md-2 col-form-label text-md-right">Nombre Api</label>
                                <div class="col-md-7">
                                    <input type="text" id="nob_api" class="form-control" name="nob_api" maxlength="50" value="{{ old('nob_api') }}" autofocus >
                                    @error('nob_api')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <textarea class="form-control" id="des_api" name="des_api" rows="3"></textarea>
                                    @error('des_api')
                                        <span style="color:red;">* 
                                            {{ $message }}
                                        </span>
